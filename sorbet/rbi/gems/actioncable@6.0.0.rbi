...
module ActionCable::Channel::TestCase::Behavior
  ...
  def perform(action, data = _); end
  def stub_connection(identifiers = _); end
  def subscribe(params = _); end
...
class ActionCable::Connection::Base
  ...
  def beat; end
  def close(reason: _, reconnect: _); end
...
module ActionCable::Connection::TestCase::Behavior
  ...
  def connect(path = _, **request_params); end
  def cookies; end
  def disconnect; end

  private

  def build_test_request(path, params: _, headers: _, session: _, env: _); end
end
...
class ActionCable::Channel::ConnectionStub
  def initialize(identifiers = _); end
