...
class Dalli::Client
  def initialize(servers = _, options = _); end

  def add(key, value, ttl = _, options = _); end
  def alive!; end
  def append(key, value); end
  def cas(key, ttl = _, options = _, &block); end
  def cas!(key, ttl = _, options = _, &block); end
  def close; end
  def decr(key, amt = _, ttl = _, default = _); end
  def delete(key); end
  def fetch(key, ttl = _, options = _); end
  def flush(delay = _); end
  def flush_all(delay = _); end
  def get(key, options = _); end
  def get_multi(*keys); end
  def incr(key, amt = _, ttl = _, default = _); end
  def multi; end
  def prepend(key, value); end
  def replace(key, value, ttl = _, options = _); end
  def reset; end
  def reset_stats; end
  def set(key, value, ttl = _, options = _); end
  def stats(type = _); end
  def touch(key, ttl = _); end
  def version; end
  def with; end

  private

  def cas_core(key, always_set, ttl = _, options = _); end
...
class Dalli::Server
  def initialize(attribs, options = _); end
  ...
  def flush(ttl); end
  def generic_response(unpack = _, cache_nils = _); end
  def get(key, options = _); end
  ...
  def serialize(key, value, options = _); end
  def set(key, value, ttl, cas, options); end
  def split(n); end
  def stats(info = _); end
...
class Dalli::Server::KSocket::TCP < ::TCPSocket
  ...
  def self.open(host, port, server, options = _); end
end
...
class Dalli::Server::KSocket::UNIX < ::UNIXSocket
  ...
  def self.open(path, server, options = _); end
end
...
class Rack::Session::Dalli < ::Rack::Session::Abstract::Persisted
  ...
  def with_block(env, default = _, &block); end
end
