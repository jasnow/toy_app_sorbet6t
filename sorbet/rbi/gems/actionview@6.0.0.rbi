...
class ActionView::AbstractRenderer
  ...
  def build_rendered_template(content, template, layout = _); end
...
class ActionView::Base
  ...
  def initialize(lookup_context = _, assigns = _, controller = _, formats = _); end
  ...
  def self.with_context(context, assigns = _, controller = _); end
  def self.with_empty_template_cache; end
  def self.with_view_paths(view_paths, assigns = _, controller = _); end
...
class ActionView::Digestor
  def self.digest(name:, finder:, format: _, dependencies: _); end
  def self.logger; end
...
module ActionView::Helpers::CacheHelper
  ...
  def cache_fragment_name(name = _, skip_digest: _, virtual_path: _, digest_path: _); end
...
class ActionView::Helpers::DateTimeSelector
  ...
  def build_year_options(selected, options = _); end
...
module ActionView::Layouts
  ...
  def _default_layout(lookup_context, formats, require_layout = _); end
...
class ActionView::Resolver
  ...
  def find_templates(name, prefix, partial, details, locals = _); end
...
class ActionView::StreamingTemplateRenderer < ::ActionView::TemplateRenderer
  def render_template(view, template, layout_name = _, locals = _); end
...
class ActionView::Template
  ...
  def initialize(source, identifier, handler, format: _, variant: _, locals: _, virtual_path: _, updated_at: _); end
