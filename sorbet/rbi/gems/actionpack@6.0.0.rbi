...
module AbstractController::Caching
  ...
  def cache(key, options = _, &block); end
end
...
module AbstractController::Caching::Fragments
  ...
  def expire_fragment(key, options = _); end
  def fragment_exist?(key, options = _); end
  def instrument_fragment_cache(name, key); end
  def read_fragment(key, options = _); end
  def write_fragment(key, content, options = _); end
end

module AbstractController::Caching::Fragments::ClassMethods
  def fragment_cache_key(value = _, &key); end
end
...
module AbstractController::Callbacks::ClassMethods
  def _insert_callbacks(callbacks, block = _); end
...
module ActionController::ConditionalGet
  ...
  def expires_in(seconds, options = _); end
  def expires_now; end
  def fresh_when(object = _, etag: _, weak_etag: _, strong_etag: _, last_modified: _, public: _, template: _); end
  def http_cache_forever(public: _); end
  def stale?(object = _, **freshness_kwargs); end
...
module ActionController::ContentSecurityPolicy::ClassMethods
  def content_security_policy(enabled = _, **options, &block); end
  def content_security_policy_report_only(report_only = _, **options); end
end
...
module ActionController::DataStreaming
  ...
  def send_data(data, options = _); end
  def send_file(path, options = _); end
...
module ActionController::Flash
  ...
  def redirect_to(options = _, response_options_and_flash = _); end
end
...
module ActionController::HttpAuthentication::Basic::ControllerMethods
  ...
  def authenticate_or_request_with_http_basic(realm = _, message = _, &login_procedure); end
  def authenticate_with_http_basic(&login_procedure); end
  def http_basic_authenticate_or_request_with(name:, password:, realm: _, message: _); end
  def request_http_basic_authentication(realm = _, message = _); end
end

module ActionController::HttpAuthentication::Basic::ControllerMethods::ClassMethods
  def http_basic_authenticate_with(name:, password:, realm: _, **options); end
end
...
module ActionController::HttpAuthentication::Digest
  ...
  def authentication_request(controller, realm, message = _); end
  ...
  def expected_response(http_method, uri, credentials, password, password_is_ha1 = _); end
  def ha1(credentials, password); end
  def nonce(secret_key, time = _); end
  def opaque(secret_key); end
  def secret_token(request); end
  def validate_digest_response(request, realm, &password_procedure); end
  def validate_nonce(secret_key, request, value, seconds_to_timeout = _); end
end

module ActionController::HttpAuthentication::Digest::ControllerMethods
  def authenticate_or_request_with_http_digest(realm = _, message = _, &password_procedure); end
  def authenticate_with_http_digest(realm = _, &password_procedure); end
  def request_http_digest_authentication(realm = _, message = _); end
end
...
module ActionController::HttpAuthentication::Token
  ...
  def authentication_request(controller, realm, message = _); end
  def encode_credentials(token, options = _); end
...
module ActionController::HttpAuthentication::Token::ControllerMethods
  def authenticate_or_request_with_http_token(realm = _, message = _, &login_procedure); end
  def authenticate_with_http_token(&login_procedure); end
  def request_http_token_authentication(realm = _, message = _); end
end
...
class ActionController::Live::SSE
  def initialize(stream, options = _); end

  def close; end
  def write(object, options = _); end
...
class ActionController::MimeResponds::Collector
  ...
  def initialize(mimes, variant = _); end
...
class ActionController::Parameters
  def initialize(parameters = _); end
...
module ActionController::ParamsWrapper::ClassMethods
  ...
  def inherited(klass); end
  def wrap_parameters(name_or_model_or_options, options = _); end
end
...
module ActionController::Redirecting
  ...
  def redirect_back(fallback_location:, allow_other_host: _, **args); end
  def redirect_to(options = _, response_options = _); end
...
class ActionController::Renderer
  ...
  def self.for(controller, env = _, defaults = _); end
end
...
module ActionController::Rendering
  ...
  def _normalize_args(action = _, options = _, &blk); end
  def _normalize_options(options); end
...
module ActionController::RequestForgeryProtection
  ...
  def form_authenticity_token(form_options: _); end
  def handle_unverified_request; end
  def mark_for_same_origin_verification!; end
  def marked_for_same_origin_verification?; end
  def masked_authenticity_token(session, form_options: _); end
...
module ActionController::RequestForgeryProtection::ClassMethods
  def protect_from_forgery(options = _); end
  def skip_forgery_protection(options = _); end
...
module ActionController::TestCase::Behavior
  ...
  def process(action, method: _, params: _, session: _, body: _, flash: _, format: _, xhr: _, as: _); end
...
module ActionDispatch::Assertions::ResponseAssertions
  ...
  def assert_response(type, message = _); end

  private

  def code_with_name(code_or_name); end
  def generate_response_message(expected, actual = _); end
...
module ActionDispatch::Assertions::RoutingAssertions
  def assert_generates(expected_path, options, defaults = _, extras = _, message = _); end
  def assert_recognizes(expected_options, path, extras = _, msg = _); end
  def assert_routing(path, options, defaults = _, extras = _, message = _); end
  ...
  def recognized_request_for(path, extras = _, msg); end
end
...
class ActionDispatch::ContentSecurityPolicy
  ...
  def block_all_mixed_content(enabled = _); end
  def build(context = _, nonce = _, nonce_directives = _); end
  ...
  def upgrade_insecure_requests(enabled = _); end
...
class ActionDispatch::Cookies::AbstractCookieJar
  ...
  def parse(name, data, purpose: _); end
end
...
class ActionDispatch::Cookies::CookieJar
  ...
  def deleted?(name, options = _); end
  def each(&block); end
...
class ActionDispatch::Cookies::EncryptedKeyRotatingCookieJar < ::ActionDispatch::Cookies::AbstractCookieJar
  ...
  def commit(name, options); end
  def parse(name, encrypted_message, purpose: _); end
end
...
class ActionDispatch::Cookies::SignedKeyRotatingCookieJar < ::ActionDispatch::Cookies::AbstractCookieJar
  ...
  def commit(name, options); end
  def parse(name, signed_message, purpose: _); end
end
...
class ActionDispatch::DebugExceptions
  def initialize(app, routes_app = _, response_format = _, interceptors = _); end
  ...
  def self.register_interceptor(object = _, &block); end
end

class ActionDispatch::DebugLocks
  def initialize(app, path = _); end
...
class ActionDispatch::Flash::FlashHash
  ...
  def initialize(flashes = _, discard = _); end
...
class ActionDispatch::HostAuthorization
  def initialize(app, hosts, response_app = _); end
...
module ActionDispatch::Http::URL
  ...
  def standard_port?; end
  def subdomain(tld_length = _); end
  def subdomains(tld_length = _); end
  def tld_length; end
...
class ActionDispatch::Http::UploadedFile
  ...
  def path; end
  def read(length = _, buffer = _); end
  def rewind; end
  def size; end
  def tempfile; end
  def tempfile=(_); end
...
class ActionDispatch::Integration::Session
  ...
  def host!(_); end
  def host=(_); end
  def https!(flag = _); end
  def https?; end
  def path(*args, &block); end
  def process(method, path, params: _, headers: _, env: _, xhr: _, as: _); end
...
class ActionDispatch::Journey::Formatter
  ...
  def clear; end
  def generate(name, options, path_parameters, parameterize = _); end
  def routes; end
  ...
  def build_cache; end
  def cache; end
  def extract_parameterized_parts(route, options, recall, parameterize = _); end
  def match_route(name, options); end
  def missing_keys(route, parts); end
  def named_routes; end
  def non_recursive(cache, options); end
  def possibles(cache, options, depth = _); end
end
...
class ActionDispatch::Journey::GTG::TransitionTable
  ...
  def to_svg; end
  def transitions; end
  def visualizer(paths, title = _); end
...
class ActionDispatch::Journey::Route
  def initialize(name, app, path, constraints, required_defaults, defaults, request_method_match, precedence, scope_options, internal = _); end
...
class ActionDispatch::RemoteIp
  def initialize(app, ip_spoofing_check = _, custom_proxies = _); end
...
class ActionDispatch::Request::Session
  ...
  def empty?; end
  def exists?; end
  def fetch(key, default = _, &block); end
  def has_key?(key); end
  def id; end
  def include?(key); end
  def inspect; end
...
class ActionDispatch::Response
  ...
  def initialize(status = _, header = _, body = _); end
  ...
  def self.create(status = _, header = _, body = _, default_headers: _); end
...
module ActionDispatch::Routing::Mapper::Base
  ...
  def match(path, options = _); end
  def mount(app, options = _); end
...
module ActionDispatch::Routing::Mapper::Concerns
  def concern(name, callable = _, &block); end
...
module ActionDispatch::Routing::Mapper::CustomUrls
  def direct(name, options = _, &block); end
...
class ActionDispatch::Routing::Mapper::Resources::Resource
  def initialize(entities, api_only, shallow, options = _); end
...
class ActionDispatch::Routing::Mapper::Scope
  ...
  def initialize(hash, parent = _, scope_level = _); end
...
module ActionDispatch::Routing::Mapper::Scoping
  def constraints(constraints = _); end
  def controller(controller); end
  def defaults(defaults = _); end
  def namespace(path, options = _); end
  def scope(*args); end
...
module ActionDispatch::Routing::PolymorphicRoutes
  def edit_polymorphic_path(record_or_hash, options = _); end
  def edit_polymorphic_url(record_or_hash, options = _); end
  def new_polymorphic_path(record_or_hash, options = _); end
  def new_polymorphic_url(record_or_hash, options = _); end
  def polymorphic_path(record_or_hash_or_array, options = _); end
  def polymorphic_url(record_or_hash_or_array, options = _); end
...
class ActionDispatch::Routing::RouteSet
  ...
  def define_mounted_helper(name, script_namer = _); end
  ...
  def empty?; end
  def env_key; end
  def extra_keys(options, recall = _); end
  def finalize!; end
  def find_relative_url_root(options); end
  def find_script_name(options); end
  def formatter; end
  def formatter=(_); end
  def generate_extras(options, recall = _); end
  def inspect; end
  def mounted_helpers; end
  def named_routes; end
  def named_routes=(_); end
  def optimize_routes_generation?; end
  def path_for(options, route_name = _); end
  def polymorphic_mappings; end
  def prepend(&block); end
  def recognize_path(path, environment = _); end
  def recognize_path_with_request(req, path, extras, raise_on_missing: _); end
  def relative_url_root; end
  ...
  def set; end
  def set=(_); end
  def url_for(options, route_name = _, url_strategy = _); end
  def url_helpers(supports_path = _); end

  private

  def eval_block(block); end
  def generate(route_key, options, recall = _); end
...
class ActionDispatch::Routing::RouteSet::CustomUrlHelper
  ...
  def block; end
  def call(t, args, only_path = _); end
  def defaults; end
  def name; end
...
class ActionDispatch::Routing::RoutesInspector
  ...
  def format(formatter, filter = _); end
...
class ActionDispatch::Routing::RoutesProxy
  ...
  def initialize(routes, scope, helpers, script_namer = _); end
...
module ActionDispatch::Routing::UrlFor
  ...
  def full_url_for(options = _); end
...
class ActionDispatch::SSL
  def initialize(app, redirect: _, hsts: _, secure_cookies: _); end
...
class ActionDispatch::Session::CookieStore < ::ActionDispatch::Session::AbstractStore
  ...
  def persistent_session_id!(data, sid = _); end
  def set_cookie(request, session_id, cookie); end
...
class ActionDispatch::Static
  def initialize(app, path, index: _, headers: _); end
...
module ActionDispatch::TestProcess::FixtureFile
  def fixture_file_upload(path, mime_type = _, binary = _); end
end
...
class ActionDispatch::FileHandler
  def initialize(root, index: _, headers: _); end
...
class ActionDispatch::RequestEncoder
  ...
  def self.register_encoder(mime_name, param_encoder: _, response_parser: _); end
end
...
class Mime::Type
  def initialize(string, symbol = _, synonyms = _); end
  ...
  def self.register(string, symbol, mime_type_synonyms = _, extension_synonyms = _, skip_lookup = _); end
  def self.register_alias(string, symbol, extension_synonyms = _); end
  def self.register_callback(&block); end
  def self.unregister(symbol); end
end

class Mime::Type::AcceptItem
  def initialize(index, name, q = _); end
